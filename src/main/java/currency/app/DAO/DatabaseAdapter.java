...
import currency.app.Exceptions.DatabaseException;
...
public class DatabaseAdapter {
    ...
    public <T> Optional<T> getEntityByParam(Class<T> clazz, String paramName, Object param) throws InvocationTargetException, InstantiationException, IllegalAccessException {
    ...
    public <T> List<T> getListEntities(Class<T> clazz) throws InvocationTargetException, InstantiationException, IllegalAccessException {
    ...
    public <T> int saveAndReturnId(Class<T> clazz, Object[] queryParams) {
        try (Connection connection = DataSource.getConnection()) {
